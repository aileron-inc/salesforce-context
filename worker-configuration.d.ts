/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: de38b2d1cdb0a497b637093aec7d1f4d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SF_LOGIN_URL">> {}
}
